...
public class DankersSkyblockMod {
    ...
    public static final String VERSION = "1.6.9-beta69";
    ...
    static KeyBinding[] keyBindings = new KeyBinding[5];
    ...
    public void init(FMLInitializationEvent event) {
        ...
        keyBindings[3] = new KeyBinding("Right Click Spam", Keyboard.KEY_X, "Danker's Skyblock Mod");
            ...
            if (containerChest instanceof ContainerChest) {
                ...
                if (displayName.equals("Navigate the maze!") && invSlots.size() == 90 && TerminalToggleCommand.autoTerminals && System.currentTimeMillis() - lastInteractTime >= SleepCommand.waitAmount) {
                    ...
                    if (firstCheck % 9 != 0 && firstCheck <= 53 && chest[firstCheck] == 1) {
                        ...
                        mc.playerController.windowClick(this.mazeId, firstCheck, 0, 0, (EntityPlayer)mc.thePlayer);
                        this.mazeId++;
                        ...
                        mc.playerController.windowClick(this.mazeId, secondCheck, 0, 0, (EntityPlayer)mc.thePlayer);
                        this.mazeId++;
                        lastInteractTime = System.currentTimeMillis();
                        ...
                        mc.playerController.windowClick(this.mazeId, thirdCheck, 0, 0, (EntityPlayer)mc.thePlayer);
                        this.mazeId++;
                        lastInteractTime = System.currentTimeMillis();
                        ...
                        mc.playerController.windowClick(this.mazeId, fourthCheck, 0, 0, (EntityPlayer)mc.thePlayer);
                        this.mazeId++;
                        lastInteractTime = System.currentTimeMillis();
                    }
                }
