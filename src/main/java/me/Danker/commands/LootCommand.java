...
public class LootCommand extends CommandBase {
    ...
    public static double wolfTimeSession = -1.0D;
    ...
    public static double spiderTimeSession = -1.0D;
    ...
    public static double zombieTimeSession = -1.0D;
    ...
    public static double empTimeSession = -1.0D;
    ...
    public static double yetiTimeSession = -1.0D;
    ...
    public static double f1CoinsSpentSession = 0.0D;

    public static double f1TimeSpentSession = 0.0D;

    public static int scarfStudiesSession = 0;

    public static int adaptiveSwordsSession = 0;

    public static double f2CoinsSpentSession = 0.0D;

    public static double f2TimeSpentSession = 0.0D;
    ...
    public static double f3CoinsSpentSession = 0.0D;

    public static double f3TimeSpentSession = 0.0D;
    ...
    public static double f4CoinsSpentSession = 0.0D;

    public static double f4TimeSpentSession = 0.0D;
    ...
    public static double f5CoinsSpentSession = 0.0D;

    public static double f5TimeSpentSession = 0.0D;
    ...
    public static double f6CoinsSpentSession = 0.0D;

    public static double f6TimeSpentSession = 0.0D;
    ...
    public static double f7CoinsSpentSession = 0.0D;

    public static double f7TimeSpentSession = 0.0D;
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length == 1)
            return getListOfStringsMatchingLastWord(args, new String[] { "wolf", "spider", "zombie", "fishing", "catacombs", "mythological" });
    ...
    public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
        ...
        double timeNow = (System.currentTimeMillis() / 1000L);
        ...
        switch (arg1[0].toLowerCase()) {
            ...
            case "fishing":
                if (arg1.length > 1) {
                    if (arg1[1].equalsIgnoreCase("winter")) {
                        ...
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.AQUA + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.WHITE + EnumChatFormatting.BOLD + "  Winter Fishing Summary:\n" + EnumChatFormatting.AQUA + "    Frozen Steves: " + nf
                                ...
                                .format(frozenSteves) + "\n" + EnumChatFormatting.WHITE + "    Snowmans: " + nf
                                .format(frostyTheSnowmans) + "\n" + EnumChatFormatting.DARK_GREEN + "    Grinches: " + nf
                                .format(grinches) + "\n" + EnumChatFormatting.GOLD + "    Yetis: " + nf
                                .format(yetis) + "\n" + EnumChatFormatting.AQUA + "    Time Since Yeti: " + timeBetween + "\n" + EnumChatFormatting.AQUA + "    Creatures Since Yeti: " + bossesBetween + "\n" + EnumChatFormatting.AQUA + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    }
                    if (arg1[1].equalsIgnoreCase("festival")) {
                        if (showSession) {
                        ...
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.AQUA + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + " Spooky Fishing Summary:\n" + EnumChatFormatting.BLUE + "    Scarecrows: " + nf
                                ...
                                .format(nightmares) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Werewolves: " + nf
                                .format(werewolfs) + "\n" + EnumChatFormatting.GOLD + "    Phantom Fishers: " + nf
                                .format(phantomFishers) + "\n" + EnumChatFormatting.GOLD + "    Grim Reapers: " + nf
                                .format(grimReapers) + "\n" + EnumChatFormatting.AQUA + "" + EnumChatFormatting.BOLD + "-------------------"));
                    }
                }
                if (showSession) {
                    if (empTimeSession == -1.0D) {
                        timeBetween = "Never";
                    } else {
                ...
                player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_AQUA + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.AQUA + EnumChatFormatting.BOLD + "  Fishing Summary:\n" + EnumChatFormatting.AQUA + "    Sea Creatures Caught: " + nf
                        ...
                        .format(seaWitches) + "\n" + EnumChatFormatting.GREEN + "    Sea Archers: " + nf
                        .format(seaArchers) + "\n" + EnumChatFormatting.GREEN + "    Monster of the Deeps: " + nf
                        .format(monsterOfTheDeeps) + "\n" + EnumChatFormatting.YELLOW + "    Catfishes: " + nf
                        .format(catfishes) + "\n" + EnumChatFormatting.GOLD + "    Carrot Kings: " + nf
                        .format(carrotKings) + "\n" + EnumChatFormatting.GRAY + "    Sea Leeches: " + nf
                        .format(seaLeeches) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Guardian Defenders: " + nf
                        .format(guardianDefenders) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Deep Sea Protectors: " + nf
                        .format(deepSeaProtectors) + "\n" + EnumChatFormatting.GOLD + "    Hydras: " + nf
                        .format(hydras) + "\n" + EnumChatFormatting.GOLD + "    Sea Emperors: " + nf
                        .format(seaEmperors) + "\n" + EnumChatFormatting.AQUA + "    Time Since Sea Emperor: " + timeBetween + "\n" + EnumChatFormatting.AQUA + "    Sea Creatures Since Sea Emperor: " + bossesBetween + "\n" + EnumChatFormatting.DARK_AQUA + EnumChatFormatting.BOLD + " -------------------"));
                return;
            case "mythological":
                if (showSession) {
                    player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.GOLD + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + "  Mythological Event Summary (Current Session):\n" + EnumChatFormatting.YELLOW + "    Coins: " +

                            Utils.getMoneySpent(mythCoinsSession) + "\n" + EnumChatFormatting.WHITE + "    Griffin Feathers: " + nf
                            .format(griffinFeathersSession) + "\n" + EnumChatFormatting.GOLD + "    Crown of Greeds: " + nf
                            .format(crownOfGreedsSession) + "\n" + EnumChatFormatting.AQUA + "    Washed-up Souvenirs: " + nf
                            .format(washedUpSouvenirsSession) + "\n" + EnumChatFormatting.RED + "    Minos Hunters: " + nf
                            .format(minosHuntersSession) + "\n" + EnumChatFormatting.GRAY + "   Siamese Lynxes: " + nf
                            .format(siameseLynxesSession) + "\n" + EnumChatFormatting.RED + "   Minotaurs: " + nf
                            .format(minotaursSession) + "\n" + EnumChatFormatting.WHITE + "   Gaia Constructs: " + nf
                            .format(gaiaConstructsSession) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Minos Champions: " + nf
                            .format(minosChampionsSession) + "\n" + EnumChatFormatting.GOLD + "    Minos Inquisitors: " + nf
                            .format(minosInquisitorsSession) + "\n" + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "-------------------"));
                    return;
                }
                player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.GOLD + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.YELLOW + EnumChatFormatting.BOLD + "  Mythological Event Summary:\n" + EnumChatFormatting.YELLOW + "    Coins: " +

                        Utils.getMoneySpent(mythCoins) + "\n" + EnumChatFormatting.WHITE + "    Griffin Feathers: " + nf
                        .format(griffinFeathers) + "\n" + EnumChatFormatting.GOLD + "    Crown of Greeds: " + nf
                        .format(crownOfGreeds) + "\n" + EnumChatFormatting.AQUA + "    Washed-up Souvenirs: " + nf
                        .format(washedUpSouvenirs) + "\n" + EnumChatFormatting.RED + "    Minos Hunters: " + nf
                        .format(minosHunters) + "\n" + EnumChatFormatting.GRAY + "   Siamese Lynxes: " + nf
                        .format(siameseLynxes) + "\n" + EnumChatFormatting.RED + "   Minotaurs: " + nf
                        .format(minotaurs) + "\n" + EnumChatFormatting.WHITE + "   Gaia Constructs: " + nf
                        .format(gaiaConstructs) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Minos Champions: " + nf
                        .format(minosChampions) + "\n" + EnumChatFormatting.GOLD + "    Minos Inquisitors: " + nf
                        .format(minosInquisitors) + "\n" + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "-------------------"));
                return;
            case "catacombs":
                if (arg1.length == 1) {
                    player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.ERROR_COLOUR + "Usage: /loot catacombs <f1/f2/f3/f4/f5/f6/f7>"));
                    return;
                }
                switch (arg1[1].toLowerCase()) {
                    ...
                    case "floor1":
                        if (showSession) {
                            player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F1 Summary (Current Session):\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf

                                    .format(recombobulatorsSession) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Fuming Potato Books: " + nf
                                    .format(fumingPotatoBooksSession) + "\n" + EnumChatFormatting.BLUE + "    Bonzo's Staffs: " + nf
                                    .format(bonzoStaffsSession) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                    Utils.getMoneySpent(f1CoinsSpentSession) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                    Utils.getTimeBetween(0.0D, f1TimeSpentSession) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                            return;
                        }
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F1 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf

                                .format(recombobulators) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Fuming Potato Books: " + nf
                                .format(fumingPotatoBooks) + "\n" + EnumChatFormatting.BLUE + "    Bonzo's Staffs: " + nf
                                .format(bonzoStaffs) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f1CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f1TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    case "f2":
                    case "floor2":
                        if (showSession) {
                            player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F2 Summary (Current Session):\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                    ...
                                    .format(scarfStudiesSession) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Blades: " + nf
                                    .format(adaptiveSwordsSession) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                    Utils.getMoneySpent(f2CoinsSpentSession) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                    Utils.getTimeBetween(0.0D, f2TimeSpentSession) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                            return;
                        }
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F2 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                ...
                                .format(fumingPotatoBooks) + "\n" + EnumChatFormatting.BLUE + "    Scarf's Studies: " + nf
                                .format(scarfStudies) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Blades: " + nf
                                .format(adaptiveSwords) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f2CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f2TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    case "f3":
                    case "floor3":
                        if (showSession) {
                            player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F3 Summary (Current Session):\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                    ...
                                    .format(adaptiveHelmsSession) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Chestplates: " + nf
                                    .format(adaptiveChestsSession) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Leggings: " + nf
                                    .format(adaptiveLegsSession) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Boots: " + nf
                                    .format(adaptiveBootsSession) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                    Utils.getMoneySpent(f3CoinsSpentSession) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                    Utils.getTimeBetween(0.0D, f3TimeSpentSession) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                            return;
                        }
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F3 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                ...
                                .format(recombobulators) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Fuming Potato Books: " + nf
                                .format(fumingPotatoBooks) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Helmets: " + nf
                                .format(adaptiveHelms) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Chestplates: " + nf
                                .format(adaptiveChests) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Leggings: " + nf
                                .format(adaptiveLegs) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Adaptive Boots: " + nf
                                .format(adaptiveBoots) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f3CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f3TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    case "f4":
                    case "floor4":
                        if (showSession) {
                        ...
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F4 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                ...
                                .format(spiritSwords) + "\n" + EnumChatFormatting.GOLD + "    Spirit Bows: " + nf
                                .format(spiritBows) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Epic Spirit Pets: " + nf
                                .format(epicSpiritPets) + "\n" + EnumChatFormatting.GOLD + "    Leg Spirit Pets: " + nf
                                .format(legSpiritPets) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f4CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f4TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    case "f5":
                    case "floor5":
                        if (showSession) {
                        ...
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F5 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                ...
                                .format(fumingPotatoBooks) + "\n" + EnumChatFormatting.BLUE + "    Warped Stones: " + nf
                                .format(warpedStones) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Shadow Assassin Helmets: " + nf
                                .format(shadowAssHelms) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Shadow Assassin Chests: " + nf
                                .format(shadowAssChests) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Shadow Assassin Legs: " + nf
                                .format(shadowAssLegs) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Shadow Assassin Boots: " + nf
                                .format(shadowAssBoots) + "\n" + EnumChatFormatting.GOLD + "    Last Breaths: " + nf
                                .format(lastBreaths) + "\n" + EnumChatFormatting.GOLD + "    Livid Daggers: " + nf
                                .format(lividDaggers) + "\n" + EnumChatFormatting.GOLD + "    Shadow Furys: " + nf
                                .format(shadowFurys) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f5CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f5TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    case "f6":
                    case "floor6":
                        if (showSession) {
                        ...
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F6 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                ...
                                .format(fumingPotatoBooks) + "\n" + EnumChatFormatting.BLUE + "    Ancient Roses: " + nf
                                .format(ancientRoses) + "\n" + EnumChatFormatting.GOLD + "    Precursor Eyes: " + nf
                                .format(precursorEyes) + "\n" + EnumChatFormatting.GOLD + "    Giant's Swords: " + nf
                                .format(giantsSwords) + "\n" + EnumChatFormatting.GOLD + "    Necro Lord Helmets: " + nf
                                .format(necroLordHelms) + "\n" + EnumChatFormatting.GOLD + "    Necro Lord Chestplates: " + nf
                                .format(necroLordChests) + "\n" + EnumChatFormatting.GOLD + "    Necro Lord Leggings: " + nf
                                .format(necroLordLegs) + "\n" + EnumChatFormatting.GOLD + "    Necro Lord Boots: " + nf
                                .format(necroLordBoots) + "\n" + EnumChatFormatting.GOLD + "    Necro Swords: " + nf
                                .format(necroSwords) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f6CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f6TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                    case "f7":
                    case "floor7":
                        if (showSession) {
                        ...
                        player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.DARK_RED + "" + EnumChatFormatting.BOLD + "-------------------\n" + EnumChatFormatting.RED + EnumChatFormatting.BOLD + "  Catacombs F7 Summary:\n" + EnumChatFormatting.GOLD + "    Recombobulator 3000s: " + nf
                                ...
                                .format(witherCloaks) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Implosions: " + nf
                                .format(implosions) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Wither Shields: " + nf
                                .format(witherShields) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Shadow Warps: " + nf
                                .format(shadowWarps) + "\n" + EnumChatFormatting.DARK_PURPLE + "    Necron's Handles: " + nf
                                .format(necronsHandles) + "\n" + EnumChatFormatting.GOLD + "    Auto Recombobulator: " + nf
                                .format(autoRecombs) + "\n" + EnumChatFormatting.GOLD + "    Wither Helmets: " + nf
                                .format(witherHelms) + "\n" + EnumChatFormatting.GOLD + "    Wither Chesplates: " + nf
                                .format(witherChests) + "\n" + EnumChatFormatting.GOLD + "    Wither Leggings: " + nf
                                .format(witherLegs) + "\n" + EnumChatFormatting.GOLD + "    Wither Boots: " + nf
                                .format(witherBoots) + "\n" + EnumChatFormatting.AQUA + "    Coins Spent: " +
                                Utils.getMoneySpent(f7CoinsSpent) + "\n" + EnumChatFormatting.AQUA + "    Time Spent: " +
                                Utils.getTimeBetween(0.0D, f7TimeSpent) + "\n" + EnumChatFormatting.DARK_RED + EnumChatFormatting.BOLD + " -------------------"));
                        return;
                }
                player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.ERROR_COLOUR + "Usage: /loot catacombs <f1/f2/f3/f4/f5/f6/f7>"));
                return;
