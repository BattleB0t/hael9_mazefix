...
public class ResetLootCommand extends CommandBase {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length != 1)
            return null;
        if (confirmReset)
            return getListOfStringsMatchingLastWord(args, new String[] { "confirm", "cancel" });
        return getListOfStringsMatchingLastWord(args, new String[] { "zombie", "spider", "wolf", "fishing", "mythological", "catacombs" });
    }

    public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
        EntityPlayer player = (EntityPlayer)arg0;
        if (arg1.length == 0) {
            player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.ERROR_COLOUR + "Usage: /resetloot <zombie/spider/wolf/fishing/mythological/catacombs>"));
            return;
        }
        if (confirmReset) {
            switch (arg1[0].toLowerCase()) {
                case "confirm":
                    confirmReset = false;
                    player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "Resetting " + resetOption + " tracker..."));
                    ...
                    player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "Reset complete."));
                    return;
                case "cancel":
                    confirmReset = false;
                    player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.ERROR_COLOUR + "Reset cancelled."));
                    return;
            }
            player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.RED + "Please confirm the reset of the " + resetOption + " tracker by using /resetloot confirm." + EnumChatFormatting.RED + " Cancel by using /resetloot cancel."));
        } else {
            switch (arg1[0].toLowerCase()) {
                case "zombie":
                case "spider":
                ...
                case "catacombs":
                    resetOption = arg1[0];
                    player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.YELLOW + "Are you sure you want to reset the " + resetOption + " tracker? Confirm with " + DankersSkyblockMod.MAIN_COLOUR + "/resetloot confirm" + EnumChatFormatting.YELLOW + ". Cancel by using " + DankersSkyblockMod.MAIN_COLOUR + "/resetloot cancel" + EnumChatFormatting.YELLOW + "."));
                    confirmReset = true;
                    return;
                case "confirm":
                case "cancel":
                    player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.ERROR_COLOUR + "Pick something to reset first."));
                    return;
            }
    ...
    static void resetZombie() {
        ...
        LootCommand.zombieTimeSession = -1.0D;
    ...
    static void resetSpider() {
        ...
        LootCommand.spiderTimeSession = -1.0D;
    ...
    static void resetWolf() {
        ...
        LootCommand.wolfTimeSession = -1.0D;
    ...
    static void resetFishing() {
        ...
        LootCommand.empTimeSession = -1.0D;
        ...
        LootCommand.yetiTimeSession = -1.0D;
    ...
    static void resetMythological() {
        LootCommand.mythCoinsSession = 0.0D;
    ...
    static void resetCatacombs() {
        ...
        LootCommand.f1CoinsSpentSession = 0.0D;
        LootCommand.f1TimeSpentSession = 0.0D;
        LootCommand.scarfStudiesSession = 0;
        LootCommand.f2CoinsSpentSession = 0.0D;
        LootCommand.f2TimeSpentSession = 0.0D;
        ...
        LootCommand.f3CoinsSpentSession = 0.0D;
        LootCommand.f3TimeSpentSession = 0.0D;
        ...
        LootCommand.f4CoinsSpentSession = 0.0D;
        LootCommand.f4TimeSpentSession = 0.0D;
        ...
        LootCommand.f5CoinsSpentSession = 0.0D;
        LootCommand.f5TimeSpentSession = 0.0D;
        ...
        LootCommand.f6CoinsSpentSession = 0.0D;
        LootCommand.f6TimeSpentSession = 0.0D;
        ...
        LootCommand.f7CoinsSpentSession = 0.0D;
        LootCommand.f7TimeSpentSession = 0.0D;
