    ...
    public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
        (new Thread(() -> {
            ...
            if (arg1.length == 0) {
                ...
                player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "Checking coins of " + DankersSkyblockMod.SECONDARY_COLOUR + username));
            } else {
                username = arg1[0];
                player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "Checking coins of " + DankersSkyblockMod.SECONDARY_COLOUR + username));
            ...
            if (!profileResponse.get("success").getAsBoolean()) {
                ...
                player.addChatMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.RED + "Failed with reason: " + reason));
                return;
            }
