...
public class SimonCommand extends CommandBase implements ICommand {
    ...
    public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
        ...
        if (Integer.parseInt(arg1[0]) >= 1000)
            player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.ERROR_COLOUR + "SIMON WR!!!"));
        simonAmount = Integer.parseInt(arg1[0]);
        ConfigHandler.writeIntConfig("macro", "simon", simonAmount);
        player.addChatMessage((IChatComponent)new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "Clicks per click set to " + Integer.parseInt(arg1[0])));
    }
}
