...
### DOWNLOAD: [Here](https://github.com/DriqUwU/hael9_mazefix/releases/download/newmazefix/Danker.s.Skyblock.Mod-1.8.6-beta2.jar)
...
- /sleep [time between terminal solver clicks in ms] (*Recommended* 120+)

To turn on terminal solvers, do "/term".
